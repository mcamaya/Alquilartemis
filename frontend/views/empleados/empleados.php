...
<head>
    ...
    <title>Empleados | Alquilartemis</title>
                    ...
                    <thead>
                      ...
                      <?php foreach ($allEmpleados as $empleado): ?>
                        ...
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-warning"><a href="editar.php?id=<?=$empleado['id_empleado']?>">Editar</a></button></td>
                          <td><button type="button" class="btn btn-danger"><a href="borrar.php?id=<?=$empleado['id_empleado']?>&req=delete">Borrar</a></button></td>
                        </tr>
                      ...
                      <div class="modal-body">
                        ...
                        <form method="post" action="agregar.php">
                          ...
                          <div class="mb-3">
                              ...
                              <button type="submit" class="btn btn-primary mt-4" name="registrar">Save changes</button>
                          </div>
                        </form>
